                ...
                <div class="portlet light ">
                    <div class="portlet-title">
                        <div class="caption caption-md">
                            ...
                            <span class="caption-subject font-blue-madison bold uppercase">All Users In our system</span>
                        </div>
                        <!-- Date filter -->
                        <!-- <div class="actions">
                        ...
                        <div class="table-scrollable table-scrollable-borderless">
                            <table class="table table-hover table-light">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:;" class="primary-link">User1</a>
                                    </td>
                                    <td> vendor </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:;" class="primary-link">User2</a>
                                    </td>
                                    <td> user </td>
                                    <td> testing@gmail.com </td>
                                    <td> Feb.10.2017 </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:;" class="primary-link">User3</a>
                                    </td>
                                    <td> vendor </td>
                                    <td> testing@gmail.com </td>
                                    <td> Feb.10.2017 </td>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="javascript:;" class="primary-link">User4</a>
                                    </td>
                                    <td> user </td>
                                    <td> testing@gmail.com </td>
                                    <td> Feb.10.2017 </td>
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic" src="
                                                            /assets/pages/media/users/avatar7.jpg"> </td>
                                    <td>
                                        <a href="javascript:;" class="primary-link">User5</a>
                                    </td>
                                    <td> vendor </td>
                                    <td> testing@gmail.com </td>
                                    <td> Feb.10.2017 </td>
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic" src="
                                                            /assets/pages/media/users/avatar7.jpg"> </td>
                                    <td>
                                        <a href="javascript:;" class="primary-link">User6</a>
                                    </td>
                                    <td> vendor </td>
                                    <td> testing@gmail.com </td>
                                    <td> Feb.10.2017 </td>
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic" src="
                                                            /assets/pages/media/users/avatar7.jpg"> </td>
                                    <td>
                                        <a href="javascript:;" class="primary-link">User7</a>
                                    </td>
                                    <td> user </td>
                                    <td> testing@gmail.com </td>
                                    <td> Feb.10.2017 </td>
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic" src="
                                                            /assets/pages/media/users/avatar7.jpg"> </td>
                                    <td>
                                        <a href="javascript:;" class="primary-link">User8</a>
                                    </td>
                                    <td> user </td>
                                    <td> testing@gmail.com </td>
                                    <td> Feb.10.2017 </td>
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic" src="
                                                            /assets/pages/media/users/avatar7.jpg"> </td>
                                    <td>
                                        <a href="javascript:;" class="primary-link">User9</a>
                                    </td>
                                    <td> vendor </td>
                                    <td> testing@gmail.com </td>
                                    <td> Feb.10.2017 </td>
                                ...
                                <tr>
                                    <td class="fit">
                                        <img class="user-pic" src="
                                                            /assets/pages/media/users/avatar7.jpg"> </td>
                                    <td>
                                        <a href="javascript:;" class="primary-link">User10</a>
                                    </td>
                                    <td> user </td>
                                    <td> testing@gmail.com </td>
                                    <td> Feb.10.2017 </td>
